...
namespace MDMLibrary.Crypto
{
    public class CryptoRsa : ICrypto
    {
        ...
        public CryptoRsa(string key, int keySize = 2048)
        {
            Rsa = RSA.Create();
            Rsa.KeySize = keySize;
            Info = CreateDetails();
        ...
        public CryptoRsa(FileInfo fileInfo, int keySize = 2048)
        {
            Rsa = RSA.Create();
            Rsa.KeySize = keySize;
            Info = CreateDetails();
        ...
        public CryptoRsa(X509Certificate2? certificate, KeyType keyType, int keySize = 2048)
        {
            Rsa = RSA.Create();
            Rsa.KeySize = keySize;
            Info = CreateDetails();
